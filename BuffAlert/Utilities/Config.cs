...
public static class Config {
    ...
    /// <summary>
    /// Loads a character specific config file from PluginConfigs\BuffAlert\{ContentId}\{FileName}
    ...
    /// <summary>
    /// Saves a character specific config file to PluginConfigs\BuffAlert\{ContentId}\{FileName}
    /// </summary>
    /// <remarks>Requires the character to be logged in</remarks>
